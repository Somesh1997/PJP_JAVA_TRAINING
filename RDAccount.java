...
public class RDAccount implements Account{
	...
	private static int ageOfACHolder;
	private static int givenMonth;
	
	
	
	public static int getGivenMonth() {
		return givenMonth;
	}
	...
	public static int getAgeOfACHolder() {
	...
	public static double getMonthlyAmount() {
	...
	public double calculateInterest(){
     ...
     public static void calculator(double amount, double interestRate){
